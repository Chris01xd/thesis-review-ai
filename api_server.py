...
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
        "https://thesisreview-frontend.onrender.com",
        "https://thesisreview-api.onrender.com",
        "http://localhost:5173",
        "http://localhost:3000",
        "http://127.0.0.1:5173",
    ],
...
class ThesisRequest(BaseModel):
    ...
    authors_orcid: Optional[str] = None
...
def generar_tesis(req: ThesisRequest):
    ...
    try:
        result = generate_thesis({
            ...
            'authors_orcid': [o.strip() for o in req.authors_orcid.split(',')] if req.authors_orcid else [],
        })
        return result
    except Exception as e:
